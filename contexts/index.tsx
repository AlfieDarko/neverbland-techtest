...
type ShowContextType = {
  ...
  setShowBackgrounds: React.Dispatch<
    React.SetStateAction<IShowBackgroundImage[] | []>
  >;
};
...
export const ShowProvider: React.FC<{ children: ReactNode }> = ({
  ...
  const [showData, setShowData] = useState<IShowInfo[] | []>([]);
...
export const useShowContext = (): [
  IShowInfo[] | null,
  React.Dispatch<React.SetStateAction<IShowInfo[] | []>>,
  boolean,
